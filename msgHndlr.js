/*
* Bot Official DeepGoreCreepypasta!
*
* Owner 085559038021 (MRHRTZ @ DGC Team Attacker) 
*
*/
...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        case '!.':
         ...
         default:
            if (command.startsWith('!')) {
                client.reply(from, `Hai ${pushname} Bot ini terdeteksi illegal dan tanpa lisensi, apabila ingin mengaktifkannya mohon konfirmasi ke owner official bot dgc wa.ne/6285559038021`, id)
            } 
        }
