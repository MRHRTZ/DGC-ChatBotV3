...
//const selfHndlr = require('./msgHndlr')
...
require('./selfHndlr')
nocache('./selfHndlr', module => INFOLOG(`${module} Telah diupdate!`))
...
const start = async (hurtz = new Hurtz()) => {
        ...
        //    selfHndlr(hurtz, message)
        // Message Handler (Loaded from recent cache)
        require('./selfHndlr')(hurtz, message)
        }))
        ...
        hurtz.onIncomingCall(( async (call) => {
            await hurtz.sendText(call.peerJid, 'Tunggu sebentar apabila telp anda tidak diresp.')
